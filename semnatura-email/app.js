var app = angular.module("anwSignature", ["ngjsColorPicker"])
app.config(["$compileProvider", function ($compileProvider)
{
$compileProvider.debugInfoEnabled(false);
}]);
app.controller("generator", ["$scope", function($scope) {
$scope.user = {
nume: "Popescu",
prenume: "Andrei",
job: "Web Developer",
virgula: ", ",
email: "contact@greenligghtweb.ro",
telefon: "+44(0) 5555555",
mobil: "+44(0) 5555555",
website: "https://greenlightweb.ro",
companie: "Greenlight Web Agency",
adresa: " Nr. 28A, Calea Unirii, Craiova 200409",
poza:"https://greenlightweb.ro/templates/greenlight/img/semnaturi/blank-profile-picture.png",
facebook:"https://www.facebook.com/greenlightweb.ro",
twitter:"https://twitter.com/GreenlightWebRO",
linkedin:"https://www.linkedin.com/company/greenlight-web-agency",
instagram:"https://www.instagram.com/greenlightweb.ro/?hl=en"

};

$scope.exportDocument = function() {
	$scope.a = document.querySelector(".myclass").outerHTML;
};
...
app.controller("SignatureSwitcher", ["$scope", function($scope) {
$scope.items = [{
id: 1,
name: "First"
}, {
...
app.directive("ngjsColorPicker", function() {
var template =
'<ul ng-style="ulCss"> \
